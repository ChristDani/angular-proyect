...
export class Dashboard implements OnInit{
  ...
  constructor(private authService: AuthService, private accountService: AccountService, private cardService: CardService, private loanService: LoanService){}

  ngOnInit(): void {
    this.id = Number(this.authService.getLoggedInUser()?.id);
